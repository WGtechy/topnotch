...
import { componentLoader } from "../../bucket/loading-components/componentLoader";
  const AllCarts = (props) => {
    ...
    const {wishlists: data, loadingCarts: loading} = useSelector(state=>state.userProfile) 
        ...
        <AppBar>
          <Toolbar>
            <div onClick={handleClose} className="modalBack">
              ...
              <span className="headerLeftSection">All wishlists</span>
            </div>
          </Toolbar>
